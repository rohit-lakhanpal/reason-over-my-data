    ...
    jsonl_data = [
        {
            ...
            #"messages": [],
            # "messages": [{"inputs":{"question":"hi"},"outputs":{"answer":"Hello! How can I assist you today?"}}],
            "messages": [
                {
                    "role": "user",
                ...
                {
                    "content": example["reference_answer"],
                    "role": "assistant",
                    "context": {
                        "citations": [                            
                            {
                                ...
                                "content": " ".join(example["reference_contexts"])
                            }
                        ]
                    }
                }
            ],
            # ground_truth: The response to question generated by user/human as the true answer
            "ground_truth": " ".join(example["reference_contexts"]),
            # context	The source that response is generated with respect to
            "context": " ".join(example["reference_contexts"]),
        }
